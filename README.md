...
### 5. Загрузите файл статьи через интерфейс.
   ![Загрузка файла](images/p_start3.png)
   
### 6. Выбери одну из предложенных функций, чтобы начать работу со статьёй.
...
### 7. Сохранение контекста и истории взаимодействия.
